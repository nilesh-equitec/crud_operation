...
namespace CrudOperation.Models
{
    ...
    public partial class EmployeeDBContextProcedures : IEmployeeDBContextProcedures
    {
        ...
        public virtual async Task<int> InsertEmployeeWithSkillsAsync(string Name, string Email, string Phone, string Gender, string Address, string Title, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[InsertEmployeeWithSkills] @Name, @Email, @Phone, @Gender, @Address, @Title", sqlParameters, cancellationToken);
